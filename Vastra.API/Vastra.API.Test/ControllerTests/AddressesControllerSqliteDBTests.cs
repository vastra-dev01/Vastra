...
//            await _vastraRepo.AddUserForRole(2, new User("test", "test", "9999999999", "test@123")
//            {
//                UserId = 3,
...
//            //Act
//            //add address 1
//            var addressResult1 = await _addressesController.CreateAddress(2, 3, new AddressForCreationDto()
//            {
...
//            //add address 2
//            var addressResult2 = await _addressesController.CreateAddress(2, 3, new AddressForCreationDto()
//            {
...
//            var addressResultPrimary = await _addressesController.CreateAddress(2, 3, new AddressForCreationDto()
//            {
//                City = _secondAddress.City,
//                Country = _secondAddress.Country,
//                PinCode = _secondAddress.PinCode,
...
//            //Assert
//            var address1 = await _vastraRepo.GetAddressForUserAsync(3, addressResult1Id);
//            var address2 = await _vastraRepo.GetAddressForUserAsync(3, addressResult2Id);
//            var primaryAddress = await _vastraRepo.GetAddressForUserAsync(3, addressResultPrimaryId);
